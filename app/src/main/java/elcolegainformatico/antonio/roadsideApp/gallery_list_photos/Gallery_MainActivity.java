...
public class Gallery_MainActivity extends AppCompatActivity {
    ...
    private static final String myPictureDirectory = "roadsideApp";  //Name of my Photo Directory
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_custom_title.setText(getResources().getString(R.string.GaleriaImagenes));
        ...
        //Relleno para que se pueda insertar en cualquier fila
        for(int i=0; i<8; i++){
                ...
                try {
                    ...
                    try {
                        ...
                        if(checkPermission()) {
                            ...
                            /***
                             * MIRAR ESTO POR PELOTAS... NO PUEDO PASAR + de 800KB , por pelotas tengo que reducir las fotos
                             */
                            bitmap = getResizedBitmap(bitmap, 100);
                            String myBitmap = encodeBitmapToString(bitmap);
                            imageBitmap.add(position, myBitmap); //Almaceno el bitmap convertido a String
